    ...
    try {
      ...
      return Left(
        ApiException(
          ...
          statusCode: 1,
          message: ConstStrings.kNoConnectionErrorMessage,
        ),
      );
      ...
      final errorStatus = switch (error.type) {
        DioExceptionType.connectionError => ErrorStatus.noConnection,
        DioExceptionType.receiveTimeout => ErrorStatus.noConnection,
        DioExceptionType.connectionTimeout => ErrorStatus.noConnection,
